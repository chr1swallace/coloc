...
##' @param s1 the proportion of samples in dataset 1 that are cases (only
##'   relevant for case control samples)
##' @param s2 the proportion of samples in dataset 2 that are cases (only
##'   relevant for case control samples)
