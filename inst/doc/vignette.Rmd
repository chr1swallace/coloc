...
<ul>
<li><a href="#sec-1">1. A brief outline of colocalisation analysis</a></li>
<li><a href="#sec-2">2. Usage</a></li>
<li><a href="#sec-3">3. Proportional testing</a>
<ul>
<li><a href="#sec-3-1">3.1. Principal components</a></li>
<li><a href="#sec-3-2">3.2. Bayesian model averaging</a></li>
<li><a href="#sec-3-3">3.3. Using Bayes Factors to compare specific values of \(\eta\)</a></li>
</ul>
</li>
<li><a href="#sec-4">4. (Approximate) Bayes Factor colocalisation analyses</a>
<ul>
<li><a href="#sec-4-1">4.1. Introduction</a></li>
<li><a href="#sec-4-2">4.2. The basic <code>coloc.abf</code> function</a></li>
<li><a href="#sec-4-3">4.3. The wrapper function</a></li>
</ul>
</li>
<li><a href="#sec-5">5. The difference between proportional and ABF approaches</a></li>
</ul>
</div>
</div>
...
# A brief outline of colocalisation analysis<a id="sec-1" name="sec-1"></a>
...
proportional.  This test was first proposed by Plagnol et al. <sup><a id="fnr.1" name="fnr.1" class="footref" href="#fn.1">1</a></sup>
...
a quite substantially increased type 1 error rate <sup><a id="fnr.2" name="fnr.2" class="footref" href="#fn.2">2</a></sup>.  I proposed
...
p values <sup><a id="fnr.3" name="fnr.3" class="footref" href="#fn.3">3</a></sup> to generate a Bayesian colocalisation analysis <sup><a id="fnr.4" name="fnr.4" class="footref" href="#fn.4">4</a></sup>,
...
<th scope="col" class="left">Data required</th>
<th scope="col" class="left">Dependence</th>
</tr>
...
<th scope="col" class="left">&#xa0;</th>
<th scope="col" class="left">&#xa0;</th>
<th scope="col" class="left">between datasets</th>
</tr>
</thead>

<tbody>
<tr>
<td class="left">coloc.abf</td>
<td class="left">Bayesian</td>
<td class="left">summary statistics</td>
<td class="left">independent</td>
</tr>


<tr>
<td class="left">coloc.abf.datasets</td>
<td class="left">Bayesian</td>
<td class="left">raw genotypes</td>
<td class="left">independent</td>
</tr>


<tr>
<td class="left">coloc.bma</td>
<td class="left">Proportional, averages</td>
<td class="left">raw genotypes</td>
<td class="left">independent</td>
</tr>
...
<tr>
<td class="left">coloc.pcs/coloc.test</td>
<td class="left">Proportional, based on</td>
<td class="left">raw genotypes</td>
<td class="left">independent</td>
</tr>
...
<tr>
<td class="left">&#xa0;</td>
<td class="left">PC summary of genotypes</td>
<td class="left">&#xa0;</td>
<td class="left">&#xa0;</td>
</tr>
</tbody>
...
# Proportional testing<a id="sec-3" name="sec-3"></a>

## Principal components<a id="sec-3-1" name="sec-3-1"></a>
...
## Bayesian model averaging<a id="sec-3-2" name="sec-3-2"></a>
...
## Using Bayes Factors to compare specific values of \(\eta\)<a id="sec-3-3" name="sec-3-3"></a>
...
# (Approximate) Bayes Factor colocalisation analyses<a id="sec-4" name="sec-4"></a>

## Introduction<a id="sec-4-1" name="sec-4-1"></a>
...
## The basic `coloc.abf` function<a id="sec-4-2" name="sec-4-2"></a>
...
## The wrapper function<a id="sec-4-3" name="sec-4-3"></a>
...
# The difference between proportional and ABF approaches<a id="sec-5" name="sec-5"></a>
...
demonstrated in our paper <sup><a id="fnr.4.100" name="fnr.4.100" class="footref" href="#fn.4">4</a></sup>.
...
<div class="footdef"><sup><a id="fn.1" name="fn.1" class="footnum" href="#fnr.1">1</a></sup> <http://www.ncbi.nlm.nih.gov/pubmed/19039033></div>

<div class="footdef"><sup><a id="fn.2" name="fn.2" class="footnum" href="#fnr.2">2</a></sup> <http://arxiv.org/abs/1301.5510></div>

<div class="footdef"><sup><a id="fn.3" name="fn.3" class="footnum" href="#fnr.3">3</a></sup> <http://www.ncbi.nlm.nih.gov/pubmed/18642345></div>

<div class="footdef"><sup><a id="fn.4" name="fn.4" class="footnum" href="#fnr.4">4</a></sup> <http://arxiv.org/abs/1305.4022></div>
