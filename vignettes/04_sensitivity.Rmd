...
In this case, we find there is evidence for colocalisation according to a rule \(H_4>0.5\) only for \(p_{12}>10^{-6}\), which might be less convincing than the situation above.  Note, we can also consider more complicated rules:
