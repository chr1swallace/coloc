...
What is $c_{12}$?  We can consider that at a location far from either TSS, using values suggested in @pg2020 we want $p_{12} = 5\times10^{-6} = c_{12} \times 10^{-4}\times10^{-4}$ so that $c_{12}=500$, but this calculation can be performed for other values of priors at long distance from both TSS.
